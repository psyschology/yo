...
function sendPasswordToEmail(){
    ...
    $.get('php/sendPasswordToEmail.html',
{},
function(data){
...
function print(){
    ...
    window.location="../commonApi/30_07_2024%2004_24_42%20PM47d9.pdf?type="+printType+"&sender=admin";
}
